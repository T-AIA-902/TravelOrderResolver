...
@overload
def evaluate_intent_classifiers(  # type: ignore[overload-overlap]
    ...
    """Evaluate intent classifiers (return_predictions=False)."""
    ...
...
def evaluate_intent_classifiers(
    ...
    """Evaluate intent classifiers (return_predictions=True)."""
    ...
