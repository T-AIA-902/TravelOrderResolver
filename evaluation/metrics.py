...
def format_metrics_table(metrics: Dict[str, Dict[str, float]]) -> str:
    ...
    table += "|--------|-----------|-------------|-------------|\n"
    table += f"| **Precision** | {metrics['departure']['precision']:.2f}% | {metrics['destination']['precision']:.2f}% | {metrics['both']['precision']:.2f}% |\n"
    table += f"| **Recall** | {metrics['departure']['recall']:.2f}% | {metrics['destination']['recall']:.2f}% | {metrics['both']['recall']:.2f}% |\n"
    table += f"| **F1-Score** | {metrics['departure']['f1_score']:.2f}% | {metrics['destination']['f1_score']:.2f}% | {metrics['both']['f1_score']:.2f}% |\n"
    table += f"| **Accuracy** | {metrics['departure']['accuracy']:.2f}% | {metrics['destination']['accuracy']:.2f}% | {metrics['both']['accuracy']:.2f}% |\n"
